...
#### 2025-26 LACN Operations Survey {#subtitle}
...
ggplot2::ggplot(data = reporting_data,
  ...
  ggplot2::theme(
    ...
    text = element_text(size = 35, family = params$plotfont)
  ) +
...
matrixPlot(breaks = c(0,250,500,750), #,1000),
           font = params$plotfont,
           size = 45) + 
...
write_in_gserve <- question_list$Q15$Q15_4_TEXT
